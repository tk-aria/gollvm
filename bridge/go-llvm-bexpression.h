...
public:
  ...
  // Locate 'inst' within the instructions vector, then remove all subsequent
  // instructions from the list and return them as a vector. Will assert if
  // 'inst' is not found in the list.
